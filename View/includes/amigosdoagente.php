<?php if(filter_input(INPUT_GET,'tipo')== 'Individual'){  ?>
...
<?php }else {?>
<!--Mostra os seguidores de um determinado agente organizacional-->
<div class="widget friend-list stick-widget">
    <h4 class="widget-title">Seguidores do (a): <?php echo $agentePesquisado[0]->username ?></h4>
    <div id="searchDir"></div>
    <ul id="people-list" class="friendz-list">
        <?php
            $amizade = new AmizadeModel();
