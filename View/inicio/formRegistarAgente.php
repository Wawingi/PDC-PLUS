<form method="post" >
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            <input required="" style="margin-top: 15px" type="date" class="form-control" name="datanascimento">
            <label class="control-label" for="input">Data de Nascimento</label><i class="mtrl-select"></i>            
        </div>        
        <div class="form-group col-md-6">
            <select class="custom-select mt-3" name="tipo">
    ...
    <div class="form-radio">
        <div class="radio">
            <label>
                <input type="radio" value="Masculino" name="sexo" checked="checked"/><i class="check-box"></i>Masculino
            </label>
        </div>
        <div class="radio">
            <label>
                <input type="radio" value="Feminino" name="sexo"/><i class="check-box"></i>Feminino
            </label>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="submit-btns">
        ...
        <button class="mtr-btn signin" type="submit"><span>Registar</span></button>
    </div>
</form>
