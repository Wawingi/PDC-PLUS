                                        ...
                                        <div class="central-meta">
                                            <div class="frnds">
                                                <ul class="nav nav-tabs">
                                                    <li class="nav-item"><a class="active" href="timeline-friends.html#frends" data-toggle="tab">Amigos Sugeridos: </a> 
                                                        <span>
                                                            <?php
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active fade show " id="frends" >                                                        
                                                        <?php
                                                            $username = $_SESSION['agente']->username;
                                                            foreach (AgenteModel::all(array('conditions' => array("cidade = ? OR nome LIKE '%$username%'",$_SESSION['agente']->cidade))) as $valor):
                                                                if($valor->id != $_SESSION['agente']->id){
                                                        ?>
